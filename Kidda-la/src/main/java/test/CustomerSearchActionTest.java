...
public class CustomerSearchActionTest {
	...
	// 項番1.1:検索結果が、{ "1", "青木まゆみ", "アオキマユミ", "09012345678", "東京都千代田区神田小川町1-1-1" }と一致すること
	@Test
	void 電話番号検索で該当の顧客データが返ること() throws Exception {
		...
		assertArrayEquals(
				new String[] { "1", "青木まゆみ", "アオキマユミ", "09012345678", "東京都千代田区神田小川町1-1-1" },
				result[0]);
	}

	// 項番1.2:検索結果が、{ "1", "青木まゆみ", "アオキマユミ", "09012345678", "東京都千代田区神田小川町1-1-1" }と一致すること
	@Test
	...
	// 項番1.3:検索結果が、{ "1", "青木まゆみ", "アオキマユミ", "09012345678", "東京都千代田区神田小川町1-1-1" }と一致すること
	@Test
	...
	// 項番2.1:半角空白が除去され、検索結果が、{ "1", "青木まゆみ", "アオキマユミ", "09012345678", "東京都千代田区神田小川町1-1-1" }と一致すること
	@Test
	...
	// 項番2.2:全角空白が検索結果が、{ "1", "青木まゆみ", "アオキマユミ", "09012345678", "東京都千代田区神田小川町1-1-1" }と一致すること
	@Test
